...
class View(Tk):
    ...
    def create_textboxes(self):
        box_names = Text(self.frame_middle, bg="white", height=100, width=30)
        box_tasks = Text(self.frame_middle, bg="white", height=100, width=30)
        box_result = Text(self.frame_bottom, bg="white", height=100, width=30)
